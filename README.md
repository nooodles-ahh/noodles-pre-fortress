...
This my personal fork of PF2 from my copy of the code dated April 6th, 2022. The intention was to have the 0.7 version of the game be open source as was 0.6 but I suppose they got cold feet. I feel it has been long enough now where I feel comfortable releasing this without significantly impacting the current project, in spite of how little the game has outwardly changed.

My intention with this is to finish everything I wanted to finish, plus anything else I feel like. This is being tested and ran with the 0.7 build of the game, the download can be found on the official site [here](https://dl.prefortress.com/0.7/pf2_0.7.0.7z)
