...
public:
	...
	int		m_iHud_Type;
#ifdef PF2_DLL
	int		m_nDisableGrenadesResupplying;
#endif
#endif
};
...
#ifdef PF2_DLL
	bool			CanJoinClass( CTFPlayer *pTFPlayer, int iClass );
#endif
...
#ifdef PF2_DLL
	int				GrenadesResupply( void );
	void UpdateGrenadeRegenMode( void );
#endif
protected:
...
public:
	...
	virtual bool		IsCTFFlagrun( void ){ return m_bCTFMultiFlag; }
	virtual bool		IsPayloadRace( void ){ return m_bIsPayloadRace; }
#ifdef PF2
	bool				IsEscortMode( void );
	virtual int 		GrenadesRegenerate( void ) { return m_bGrenadesRegenerate; }
#endif
	...
	void SetCivilianGoals( int iIndex, bool bCivilianGoal );
#endif
#ifdef CLIENT_DLL
...
#ifdef PF2_DLL
	void	SetGrenadesResupply( int nValue ) { m_nDisableGrenadesResupplying = nValue; }
	bool	HealthkitRepairsArmor() { return m_bHealthkitArmorRepair; }
	void	PlayerAchievementCheck( void );
	bool	m_bCheckForAchievements;
#endif
...
private:
	...
	CNetworkVar( bool, m_bCTFMultiFlag );
...
#ifdef PF2
	CNetworkVar( int, m_nDisableGrenadesResupplying );
	CNetworkArray( bool, m_iCivilianGoals, MAX_CONTROL_POINTS );
	CNetworkArray(bool, m_bControlPointsNeedingFlags, MAX_CONTROL_POINTS);
	CNetworkVar(bool, m_bGrenadesRegenerate );
	CNetworkVar(bool, m_bIsPayloadRace );
#endif
