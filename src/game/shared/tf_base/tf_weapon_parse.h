...
public:
	...
	char	m_szMuzzleFlashViewModel[128];
	float	m_flMuzzleFlashModelDuration;
	char	m_szMuzzleFlashParticleEffect[128];
	char	m_szMuzzleFlashParticleEffectViewModel[128];
	...
	char    m_szClassWeaponType[TF_CLASS_COUNT_ALL][MAX_WEAPON_STRING];
};
