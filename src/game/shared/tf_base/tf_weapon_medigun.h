...
protected:
	...
	// PFTODO Cyanide; I dunno if I should make this a networked array or if the server and client will cope
	CUtlVector< CBaseEntity *> m_PrevChargeTargets;
