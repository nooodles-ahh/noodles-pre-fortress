...
#ifdef PF2
ConVar	tf_maxspeed( "tf_maxspeed", "450", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_CHEAT | FCVAR_DEVELOPMENTONLY);
ConVar	tf_avoidteammates( "tf_avoidteammates", "1", FCVAR_REPLICATED | FCVAR_NOTIFY );
#else
...
#ifdef PF2
	mv->m_flMaxSpeed = m_pTFPlayer->GetPlayerMaxSpeed();
#else
