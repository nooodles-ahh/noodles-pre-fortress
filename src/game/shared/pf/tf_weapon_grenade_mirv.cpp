...
#define GRENADE_MIRV_MINS				Vector(-8, -5, -8) //Vector(-8, -7, -9)
#define GRENADE_MIRV_MAXS				Vector(8, 5, 8) //Vector(8, 5, 20)
															...
															CBaseCombatCharacter *pOwner, const CTFWeaponInfo &weaponInfo, float timer, int iFlags )
{
	...
	{	
		pGrenade->SetAbsAngles(pGrenade->GetAbsAngles() - QAngle(180, 0, 90));
		UTIL_SetSize( pGrenade, GRENADE_MIRV_MINS, GRENADE_MIRV_MAXS );
...
void CTFGrenadeMirvProjectile::Precache()
{
	...
	PrecacheScriptSound( "Weapon_Grenade_Mirv.Bounce" );
