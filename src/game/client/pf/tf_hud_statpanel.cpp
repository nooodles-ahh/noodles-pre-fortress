...
BEGIN_DMXELEMENT_UNPACK( RoundStats_t )
	...
	DMXELEMENT_UNPACK_FIELD( "iArmorPointsRepaired", "0", int, m_iStat[ TFSTAT_ARMORREPAIRED ] )
...
TFStatType_t g_statPriority[] = { TFSTAT_HEADSHOTS, TFSTAT_BACKSTABS, TFSTAT_MAXSENTRYKILLS, TFSTAT_HEALING, TFSTAT_HEALING_OTHER, TFSTAT_ARMORREPAIRED, TFSTAT_KILLS, TFSTAT_KILLASSISTS,
