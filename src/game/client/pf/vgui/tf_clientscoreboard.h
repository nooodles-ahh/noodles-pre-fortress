...
private:
	...
	int							m_iImageClassIcons[TF_CLASS_COUNT_ALL];
	int							m_iImageClassIconsAlt[TF_CLASS_COUNT_ALL];
	int							m_iImageClassIconsDead[TF_CLASS_COUNT_ALL];
	int							m_iImageClassIconsAltDead[TF_CLASS_COUNT_ALL];
